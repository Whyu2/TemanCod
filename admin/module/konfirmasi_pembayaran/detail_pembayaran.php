...

	{
		...
		?>
					...
					<button class="btn btn-primary">Diterima  
												...
												<a href ="<?php echo $admin_url; ?>module/konfirmasi_pembayaran/aksi_acc_pembayaran.php?id_transaksi=<?php echo $kon['id_transaksi']; ?>" 
					<button class="btn btn-danger">Ditolak  
												</button>
											</a>
					...
					<a  href ="<?php echo $admin_url; ?>adminweb.php?module=edit_kabupaten&id_kabupaten=<?php echo $kab ['id_kabupaten']; ?>"> <button class="btn btn-secondary">Rincian
												</button></a>
