...
$querytambah = mysqli_query($koneksi, "INSERT INTO tbl_transaksi (id_konfirmasi,id_user,id_produk,tgl_tansaksi,tgl_tenggat,status ) VALUES ('$id_konfirmasi','$id_user','$id_produk','$tgl','$tambah','$status')");

    if ($querytambah){
        echo "<script> alert ('Transaksi berhasil disetujui '); window.location ='$admin_url'+ 'adminweb.php?module=konfirmasi_rekber';</script>";
    }else {
